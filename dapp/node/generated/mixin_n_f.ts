...
export class MixinNFContract extends BaseContract {
    /**
     * @ignore
     */
public static deployedBytecode: string | undefined;
public static contractName = 'MixinNF';
...
public static async deployFrom0xArtifactAsync(
        ...
        return MixinNFContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, );
    }
    ...
    public static async deployWithLibrariesFrom0xArtifactAsync(
        ...
        const libraryAddresses = await MixinNFContract._deployLibrariesAsync(
            artifact,
            libraryArtifacts,
    ...
    public static async deployAsync(
        ...
        logUtils.log(`MixinNF successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new MixinNFContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
        ...
        for (const link of Object.values(links)) {
            for (const libraryName of Object.keys(link)) {
                if (!libraryAddresses[libraryName]) {
                    ...
                    await MixinNFContract._deployLibrariesAsync(
                        libraryArtifact,
                        libraryArtifacts,
                        web3Wrapper,
                        txDefaults,
    ...
    public getFunctionSignature(methodName: string): string {
        ...
        const methodAbi = MixinNFContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
    ...
    public getABIDecodedTransactionData<T>(methodName: string, callData: string): T {
        ...
        const self = (this as any) as MixinNFContract;
...
> {
    ...
    constructor(
        ...
        txDefaults?: Partial<TxData>,
        logDecodeDependencies?: { [contractName: string]: ContractAbi },
        deployedBytecode: string | undefined = MixinNFContract.deployedBytecode,
    ) {
        super('MixinNF', MixinNFContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
MixinNFContract.ABI().forEach((item, index) => {
