...
export type ITokenEventArgs =
    | ITokenAuthorizedOperatorEventArgs
    | ITokenBurnedEventArgs
    | ITokenMintedEventArgs
    | ITokenRevokedOperatorEventArgs
    | ITokenSentEventArgs
    | ITokenSentEventArgs;
...
export interface ITokenAuthorizedOperatorEventArgs extends DecodedLogArgs {
    operator: string;
    holder: string;
}

export interface ITokenBurnedEventArgs extends DecodedLogArgs {
    operator: string;
    from: string;
    id: BigNumber;
    amount: BigNumber;
...
export interface ITokenMintedEventArgs extends DecodedLogArgs {
    operator: string;
    to: string;
    id: BigNumber;
    amount: BigNumber;
...
export interface ITokenRevokedOperatorEventArgs extends DecodedLogArgs {
    operator: string;
    holder: string;
}

export interface ITokenSentEventArgs extends DecodedLogArgs {
    operator: string;
    from: string;
    to: string;
    amount: BigNumber;
