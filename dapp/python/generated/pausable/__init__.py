"""Generated wrapper for Pausable Solidity contract."""
...
# constructor for Pausable below.
try:
    ...
    class PausableValidator(  # type: ignore
        Validator
    ):
...
class Pausable:
    """Wrapper class for Pausable Solidity contract."""
    ...
    def __init__(
        ...
        web3_or_provider: Union[Web3, BaseProvider],
        contract_address: str,
        validator: PausableValidator = None,
    ):
        ...
        if not validator:
            validator = PausableValidator(web3_or_provider, contract_address)
        ...
        functions = self._web3_eth.contract(
            address=to_checksum_address(contract_address), abi=Pausable.abi()
        ).functions

        self.paused = PausedMethod(web3_or_provider, contract_address, functions.paused)

    def get_paused_event(self, tx_hash: Union[HexBytes, bytes]) -> Tuple[AttributeDict]:
        ...
        return (
            self._web3_eth.contract(
                address=to_checksum_address(self.contract_address), abi=Pausable.abi()
            )
            .events.Paused()
