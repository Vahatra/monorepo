...
contract ERC1155Mintable is IERC1155Mintable, ERC1155 {
    ...
    modifier creatorOnly(uint256 _id) {
        require(creators[_id] == msg.sender, "MESSAGE");
        _;
    }
        ...
        returns (uint256 type_)
    {
        ...
        emit TransferSingle(msg.sender, address(0x0), address(0x0), type_, 0);
    ...
    /// @param uri URI of token
    function createWithType(uint256 type_, string calldata uri) external {
        // This will allow restricted access to creators.
        creators[type_] = msg.sender;
